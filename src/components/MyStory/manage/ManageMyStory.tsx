  ...
  return (
    <div className="pt-[100px] flex-col w-[98vw] sm:w-[95vw] md:w-[80vw] lg:w-[70vw] xl:w-[60vw] mx-auto pb-[20px]">
      <div className="flex justify-between items-center p-3">
        ...
        <button className="px-2 py-1 rounded-md text-sm bg-purpleRainbow active:scale-95 transition-all duration-200 ease-in-out text-white flex gap-1 items-center">
          <Plus size={16} />
