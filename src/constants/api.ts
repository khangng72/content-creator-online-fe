...
export const UPDATE_CHAPTER_TITLE = '/chapter/update-chapter-title';
...
export const GET_REPORT_PAGINATION = '/api/report/all';
export const RESOLVE_CHAPTER = '/api/report/resolve';
